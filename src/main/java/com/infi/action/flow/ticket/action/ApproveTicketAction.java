 ...
 * @since JDK 1.8
 */
public class ApproveTicketAction implements Action<TicketObject> {

  @Override
  public ExecutionResult execute(TicketObject object) {
    // Preconditions.check(currentState)s
    System.out
        .println("Approve ticket, result = " + (object.getId() % 2 == 0 ? " accept" : "reject"));
    return new ExecutionResult(object.getId() % 2 == 0);
  }
